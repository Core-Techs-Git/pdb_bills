                            ...
                            try {
                                ...
                                documents = documents.filter(doc => {
                                    ...
                                    if (!query.dateFrom && !query.dateTo)
                                        return true;
                                    if (query.dateFrom && query.dateTo)
                                        return moment_1.default(doc.formatedDateDocument, 'DD/MM/YY').isBetween(moment_1.default(query.dateFrom, 'DD/MM/YY'), moment_1.default(query.dateTo, 'DD/MM/YY'));
                                    if (query.dateFrom)
                                        return moment_1.default(doc.formatedDateDocument, 'DD/MM/YY').isAfter(moment_1.default(query.dateFrom, 'DD/MM/YY'));
                                    if (query.dateTo)
                                        return moment_1.default(doc.formatedDateDocument, 'DD/MM/YY').isBefore(moment_1.default(query.dateTo, 'DD/MM/YY'));
                                });
                                resolve(documents);
                            }
                            catch (error) {
