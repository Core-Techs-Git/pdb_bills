...
container.bind<ValidatorInterface>(TYPES.ValidatorInterface).to(SearchOptionsDTOValidator).whenTargetNamed(VALIDATORS.SEARCH_OPTIONS_DTO);
container.bind<ArchiveInterface>(TYPES.ArchiveInterface).to(Docapost).whenTargetNamed(ARCHIVE.DOCAPOSTE);
